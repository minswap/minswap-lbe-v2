...
async function processElement(
  ...
  const scriptV2 = (toScriptRef(validator).to_js_value() as { PlutusV2?: string }).PlutusV2;
...
export async function deployValidators(lucid: Translucent, validators: Validators): Promise<DeployedValidators> {
